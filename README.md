...
项目处于 `0.2.x` 迭代阶段，欢迎提交问题和改进建议。

## 给第一次使用者和贡献者

这是作者第一次正式开源项目，代码、界面和文档都还在持续改进中，感谢大家多多包涵。欢迎下载体验，并指出你遇到的问题、难用的地方和可以优化的功能。0.2.0 已上线系统提示词 v2.0.0（任务类型识别与差异化增强），初步评测（23 组有效对比：8 胜 9 平 6 负，相关性 +0.09）显示改进方向有效，完整复测结果后续补充。
