...
def create_adapter(name: str, target_cfg: dict[str, Any], global_cfg: dict[str, Any], browser_manager: Any = None) -> TargetAdapter:
    ...
    if mode == "api":
        ...
        return ApiAdapter(name, target_cfg, global_cfg)
    if mode == "mock":
